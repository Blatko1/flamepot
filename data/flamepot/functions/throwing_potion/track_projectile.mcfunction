...
execute on passengers run execute store result entity @s ArmorItems[0].tag."flamepot.burning" byte 1 run execute on vehicle run data get entity @s Item.tag."flamepot.burning"
