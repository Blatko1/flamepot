...
execute as @e[distance=0..4] run execute unless score @s flamepot.amplifier > flamepot.numberOne flamepot.constants run function flamepot:effect1/apply/splash_effect
